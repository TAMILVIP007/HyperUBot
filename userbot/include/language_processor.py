...
class AdminText(object):
    ...
    CANNOT_PROMOTE_CHANNEL = getLangString(lang, _getframe().f_code.co_name, "CANNOT_PROMOTE_CHANNEL")
    NO_ONE_TO_PROMOTE = getLangString(lang, _getframe().f_code.co_name, "NO_ONE_TO_PROMOTE")
    ...
    CANNOT_DEMOTE_CHANNEL = getLangString(lang, _getframe().f_code.co_name, "CANNOT_DEMOTE_CHANNEL")
    NO_ONE_TO_DEMOTE = getLangString(lang, _getframe().f_code.co_name, "NO_ONE_TO_DEMOTE")
...
class ModulesUtilsText(object):
    ...
    MISSING_NUMBER_MODULE = getLangString(lang, _getframe().f_code.co_name, "MISSING_NUMBER_MODULE")
    MODULE_NOT_AVAILABLE = getLangString(lang, _getframe().f_code.co_name, "MODULE_NOT_AVAILABLE")
